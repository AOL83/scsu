...
> **A self-contained execution environment disguised as a file**

Each unit can:

* run logic
* render its own interface
* manage its own state
* behave like a complete system
...
> a platform made of self-contained systems
